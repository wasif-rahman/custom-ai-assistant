...
import { Mail, Lock, User, Sun, AlertCircle } from 'lucide-react';
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-center text-white p-8">
            ...
            <p className="text-xl drop-shadow-lg">
              Experience AI powered by natural calm
            </p>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6B7F5C]" />
                <input
                  type="text"
                  value={name}
